...
#define wippersnapper_description_v1_CreateDescriptionRequest_init_default {{{NULL}, NULL}, 0, 0, 0, false, wippersnapper_description_v1_CreateDescriptionRequest_Version_init_default}
#define wippersnapper_description_v1_CreateDescriptionRequest_Version_init_default {0, 0, 0, {{NULL}, NULL}}
#define wippersnapper_description_v1_CreateDescriptionResponse_init_default {_wippersnapper_description_v1_CreateDescriptionResponse_Response_MIN}
#define wippersnapper_description_v1_GetDefinitionRequest_init_default {{{NULL}, NULL}}
#define wippersnapper_description_v1_GetDefinitionResponse_init_default {{{NULL}, NULL}}
#define wippersnapper_description_v1_CreateDescriptionRequest_init_zero {{{NULL}, NULL}, 0, 0, 0, false, wippersnapper_description_v1_CreateDescriptionRequest_Version_init_zero}
#define wippersnapper_description_v1_CreateDescriptionRequest_Version_init_zero {0, 0, 0, {{NULL}, NULL}}
#define wippersnapper_description_v1_CreateDescriptionResponse_init_zero {_wippersnapper_description_v1_CreateDescriptionResponse_Response_MIN}
#define wippersnapper_description_v1_GetDefinitionRequest_init_zero {{{NULL}, NULL}}
#define wippersnapper_description_v1_GetDefinitionResponse_init_zero {{{NULL}, NULL}}

/* Field tags (for use in manual encoding/decoding) */
#define wippersnapper_description_v1_GetDefinitionRequest_data_tag 1
#define wippersnapper_description_v1_GetDefinitionResponse_board_definition_tag 1
#define wippersnapper_description_v1_CreateDescriptionRequest_Version_major_tag 1
#define wippersnapper_description_v1_CreateDescriptionRequest_Version_minor_tag 2
#define wippersnapper_description_v1_CreateDescriptionRequest_Version_micro_tag 3
#define wippersnapper_description_v1_CreateDescriptionRequest_Version_label_tag 4
...
X(a, CALLBACK, SINGULAR, STRING,   machine_name,      1) \
...
#define wippersnapper_description_v1_CreateDescriptionRequest_CALLBACK pb_default_field_callback
...
#define wippersnapper_description_v1_GetDefinitionRequest_CALLBACK pb_default_field_callback
...
#define wippersnapper_description_v1_GetDefinitionResponse_CALLBACK pb_default_field_callback
...
#define wippersnapper_description_v1_CreateDescriptionResponse_size 2
/* wippersnapper_description_v1_GetDefinitionRequest_size depends on runtime parameters */
/* wippersnapper_description_v1_GetDefinitionResponse_size depends on runtime parameters */
