...
typedef struct _wippersnapper_pin_v1_PinEvent {
    pb_callback_t pin_name;
    pb_callback_t pin_value;
...
#define wippersnapper_pin_v1_ConfigurePinRequest_init_default {{{NULL}, NULL}, _wippersnapper_pin_v1_ConfigurePinRequest_Mode_MIN, _wippersnapper_pin_v1_ConfigurePinRequest_Direction_MIN, _wippersnapper_pin_v1_ConfigurePinRequest_Pull_MIN, 0}
...
#define wippersnapper_pin_v1_PinEvent_init_default {{{NULL}, NULL}, {{NULL}, NULL}}
...
#define wippersnapper_pin_v1_ConfigurePWMPinRequest_init_default {{{NULL}, NULL}, 0, 0, 0}
...
#define wippersnapper_pin_v1_ConfigurePinRequest_init_zero {{{NULL}, NULL}, _wippersnapper_pin_v1_ConfigurePinRequest_Mode_MIN, _wippersnapper_pin_v1_ConfigurePinRequest_Direction_MIN, _wippersnapper_pin_v1_ConfigurePinRequest_Pull_MIN, 0}
...
#define wippersnapper_pin_v1_PinEvent_init_zero  {{{NULL}, NULL}, {{NULL}, NULL}}
...
#define wippersnapper_pin_v1_ConfigurePWMPinRequest_init_zero {{{NULL}, NULL}, 0, 0, 0}
...
#define wippersnapper_pin_v1_ConfigurePinRequest_CALLBACK pb_default_field_callback
...
X(a, CALLBACK, SINGULAR, STRING,   pin_name,          1) \
X(a, CALLBACK, SINGULAR, STRING,   pin_value,         2)
#define wippersnapper_pin_v1_PinEvent_CALLBACK pb_default_field_callback
...
#define wippersnapper_pin_v1_ConfigurePWMPinRequest_CALLBACK pb_default_field_callback
...
/* wippersnapper_pin_v1_ConfigurePinRequest_size depends on runtime parameters */
...
/* wippersnapper_pin_v1_PinEvent_size depends on runtime parameters */
/* wippersnapper_pin_v1_PinEvents_size depends on runtime parameters */
#define wippersnapper_pin_v1_PinEventResponse_size 2
/* wippersnapper_pin_v1_ConfigurePWMPinRequest_size depends on runtime parameters */
