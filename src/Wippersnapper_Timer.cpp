...
void WSTimer::deleteTimer(int timerId) {
...
bool WSTimer::isEnabled(int numTimer) {
...
void WSTimer::enable(int numTimer) {
    if (numTimer >= MAX_TIMERS) {
        return;
    }
...
void WSTimer::disable(int numTimer) {
    if (numTimer >= MAX_TIMERS) {
        return;
    }
