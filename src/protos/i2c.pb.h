...
typedef struct _wippersnapper_i2c_I2cBusScan {
    bool scan_default_bus; /* * If true, linearly scan across the default hardware I2C bus. If false, linear scan across alt. hardware I2C bus. * */
    bool scan_mux; /* * If true, request a scan on an I2C multiplexer connected to a bus. If false or not marked, ignore. * */
    bool has_i2c_device_description;
    wippersnapper_i2c_I2cDeviceDescriptor i2c_device_description; /* * Optional I2C bus metadata. * */
...
#define wippersnapper_i2c_I2cBusScan_init_default {0, 0, false, wippersnapper_i2c_I2cDeviceDescriptor_init_default}
...
#define wippersnapper_i2c_I2cBusScan_init_zero   {0, 0, false, wippersnapper_i2c_I2cDeviceDescriptor_init_zero}
...
#define wippersnapper_i2c_I2cBusScan_scan_mux_tag 2
#define wippersnapper_i2c_I2cBusScan_i2c_device_description_tag 3
...
X(a, STATIC,   SINGULAR, BOOL,     scan_mux,          2) \
X(a, STATIC,   OPTIONAL, MESSAGE,  i2c_device_description,   3)
#define wippersnapper_i2c_I2cBusScan_CALLBACK NULL
#define wippersnapper_i2c_I2cBusScan_DEFAULT NULL
#define wippersnapper_i2c_I2cBusScan_i2c_device_description_MSGTYPE wippersnapper_i2c_I2cDeviceDescriptor
...
#define wippersnapper_i2c_I2cBusScan_size        56
