...
typedef struct _wippersnapper_i2c_I2cMuxDescriptor {
    bool use_default_bus; /* * True if the mux is on the default I2C bus, False otherwise. * */
    uint32_t i2c_mux_address; /* * I2C multiplexer address. * */
    uint32_t i2c_mux_channel; /* * I2C multiplexer channel. * */
} wippersnapper_i2c_I2cMuxDescriptor;
...
typedef struct _wippersnapper_i2c_I2cBusScan {
    ...
    bool scan_muxes; /* * Optional - Scan 1+ I2C multiplexers connected to an I2C bus. * */
    pb_size_t i2c_mux_descriptors_count;
    wippersnapper_i2c_I2cMuxDescriptor i2c_mux_descriptors[2]; /* * Optional - I2C multiplexer addresses and channels. * */
...
#define wippersnapper_i2c_I2cMuxDescriptor_init_default {0, 0, 0}
#define wippersnapper_i2c_I2cBusDescriptor_init_default {"", ""}
#define wippersnapper_i2c_I2cBusScan_init_default {0, 0, false, wippersnapper_i2c_I2cBusDescriptor_init_default, 0, 0, {wippersnapper_i2c_I2cMuxDescriptor_init_default, wippersnapper_i2c_I2cMuxDescriptor_init_default}}
...
#define wippersnapper_i2c_I2cMuxDescriptor_init_zero {0, 0, 0}
#define wippersnapper_i2c_I2cBusDescriptor_init_zero {"", ""}
#define wippersnapper_i2c_I2cBusScan_init_zero   {0, 0, false, wippersnapper_i2c_I2cBusDescriptor_init_zero, 0, 0, {wippersnapper_i2c_I2cMuxDescriptor_init_zero, wippersnapper_i2c_I2cMuxDescriptor_init_zero}}
...
#define wippersnapper_i2c_I2cMuxDescriptor_use_default_bus_tag 1
#define wippersnapper_i2c_I2cMuxDescriptor_i2c_mux_address_tag 2
#define wippersnapper_i2c_I2cMuxDescriptor_i2c_mux_channel_tag 3
...
#define wippersnapper_i2c_I2cBusScan_scan_muxes_tag 4
#define wippersnapper_i2c_I2cBusScan_i2c_mux_descriptors_tag 5
...
#define wippersnapper_i2c_I2cMuxDescriptor_FIELDLIST(X, a) \
X(a, STATIC,   SINGULAR, BOOL,     use_default_bus,   1) \
X(a, STATIC,   SINGULAR, UINT32,   i2c_mux_address,   2) \
X(a, STATIC,   SINGULAR, UINT32,   i2c_mux_channel,   3)
#define wippersnapper_i2c_I2cMuxDescriptor_CALLBACK NULL
#define wippersnapper_i2c_I2cMuxDescriptor_DEFAULT NULL
...
X(a, STATIC,   SINGULAR, BOOL,     scan_muxes,        4) \
X(a, STATIC,   REPEATED, MESSAGE,  i2c_mux_descriptors,   5)
...
#define wippersnapper_i2c_I2cBusScan_i2c_mux_descriptors_MSGTYPE wippersnapper_i2c_I2cMuxDescriptor
...
extern const pb_msgdesc_t wippersnapper_i2c_I2cMuxDescriptor_msg;
...
#define wippersnapper_i2c_I2cMuxDescriptor_fields &wippersnapper_i2c_I2cMuxDescriptor_msg
...
#define wippersnapper_i2c_I2cBusScan_size        72
#define wippersnapper_i2c_I2cBusScanned_size     6242
#define wippersnapper_i2c_I2cDeviceAddOrReplace_size 103
...
#define wippersnapper_i2c_I2cMuxDescriptor_size  14
