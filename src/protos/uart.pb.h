...
typedef struct _wippersnapper_uart_UartB2D {
    pb_size_t which_payload;
    union {
...
typedef struct _wippersnapper_uart_UartD2B {
    pb_size_t which_payload;
    union {
        wippersnapper_uart_UartAdded uart_added;
        wippersnapper_uart_UartWritten uart_written;
        wippersnapper_uart_UartInputEvent uart_input_event;
    } payload;
} wippersnapper_uart_UartD2B;
...
#define wippersnapper_uart_UartB2D_init_default  {0, {wippersnapper_uart_UartAdd_init_default}}
#define wippersnapper_uart_UartD2B_init_default  {0, {wippersnapper_uart_UartAdded_init_default}}
#define wippersnapper_uart_UartSerialConfig_init_default {"", "", {{NULL}, NULL}, 0, 0, _wippersnapper_uart_UartPacketFormat_MIN, 0, 0, 0}
...
#define wippersnapper_uart_UartB2D_init_zero     {0, {wippersnapper_uart_UartAdd_init_zero}}
#define wippersnapper_uart_UartD2B_init_zero     {0, {wippersnapper_uart_UartAdded_init_zero}}
#define wippersnapper_uart_UartSerialConfig_init_zero {"", "", {{NULL}, NULL}, 0, 0, _wippersnapper_uart_UartPacketFormat_MIN, 0, 0, 0}
...
#define wippersnapper_uart_UartSerialConfig_device_name_tag 3
#define wippersnapper_uart_UartSerialConfig_uart_nbr_tag 4
#define wippersnapper_uart_UartSerialConfig_baud_rate_tag 5
#define wippersnapper_uart_UartSerialConfig_format_tag 6
#define wippersnapper_uart_UartSerialConfig_timeout_tag 7
#define wippersnapper_uart_UartSerialConfig_use_sw_serial_tag 8
#define wippersnapper_uart_UartSerialConfig_sw_serial_invert_tag 9
...
#define wippersnapper_uart_UartB2D_uart_add_tag  10
#define wippersnapper_uart_UartB2D_uart_remove_tag 11
#define wippersnapper_uart_UartB2D_uart_write_tag 12
...
#define wippersnapper_uart_UartD2B_uart_added_tag 10
#define wippersnapper_uart_UartD2B_uart_written_tag 11
#define wippersnapper_uart_UartD2B_uart_input_event_tag 12

/* Struct field encoding specification for nanopb */
#define wippersnapper_uart_UartB2D_FIELDLIST(X, a) \
X(a, STATIC,   ONEOF,    MESSAGE,  (payload,uart_add,payload.uart_add),  10) \
X(a, STATIC,   ONEOF,    MESSAGE,  (payload,uart_remove,payload.uart_remove),  11) \
X(a, STATIC,   ONEOF,    MESSAGE,  (payload,uart_write,payload.uart_write),  12)
#define wippersnapper_uart_UartB2D_CALLBACK NULL
#define wippersnapper_uart_UartB2D_DEFAULT NULL
#define wippersnapper_uart_UartB2D_payload_uart_add_MSGTYPE wippersnapper_uart_UartAdd
#define wippersnapper_uart_UartB2D_payload_uart_remove_MSGTYPE wippersnapper_uart_UartRemove
#define wippersnapper_uart_UartB2D_payload_uart_write_MSGTYPE wippersnapper_uart_UartWrite

#define wippersnapper_uart_UartD2B_FIELDLIST(X, a) \
X(a, STATIC,   ONEOF,    MESSAGE,  (payload,uart_added,payload.uart_added),  10) \
X(a, STATIC,   ONEOF,    MESSAGE,  (payload,uart_written,payload.uart_written),  11) \
X(a, STATIC,   ONEOF,    MESSAGE,  (payload,uart_input_event,payload.uart_input_event),  12)
#define wippersnapper_uart_UartD2B_CALLBACK NULL
#define wippersnapper_uart_UartD2B_DEFAULT NULL
#define wippersnapper_uart_UartD2B_payload_uart_added_MSGTYPE wippersnapper_uart_UartAdded
#define wippersnapper_uart_UartD2B_payload_uart_written_MSGTYPE wippersnapper_uart_UartWritten
#define wippersnapper_uart_UartD2B_payload_uart_input_event_MSGTYPE wippersnapper_uart_UartInputEvent
...
#define wippersnapper_uart_UartSerialConfig_CALLBACK pb_default_field_callback
...
extern const pb_msgdesc_t wippersnapper_uart_UartB2D_msg;
extern const pb_msgdesc_t wippersnapper_uart_UartD2B_msg;
...
#define wippersnapper_uart_UartB2D_fields &wippersnapper_uart_UartB2D_msg
#define wippersnapper_uart_UartD2B_fields &wippersnapper_uart_UartD2B_msg
...
union wippersnapper_uart_UartD2B_payload_size_union {char f12[(121 + 15*wippersnapper_sensor_SensorEvent_size)]; char f0[49];};
#endif
/* wippersnapper_uart_UartB2D_size depends on runtime parameters */
/* wippersnapper_uart_UartSerialConfig_size depends on runtime parameters */
...
#define wippersnapper_uart_UartD2B_size          (0 + sizeof(union wippersnapper_uart_UartD2B_payload_size_union))
