...
#define wippersnapper_display_v1_LEDBackpackConfig_init_default {0, 0}
...
#define wippersnapper_display_v1_LEDBackpackConfig_init_zero {0, 0}
...
X(a, STATIC,   SINGULAR, UINT32,   alignment,         2)
...
#define wippersnapper_display_v1_LEDBackpackConfig_size 17
