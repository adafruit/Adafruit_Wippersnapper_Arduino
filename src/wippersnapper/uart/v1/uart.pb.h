...
#ifndef PB_WIPPERSNAPPER_UART_V1_UART_PB_H_INCLUDED
#define PB_WIPPERSNAPPER_UART_V1_UART_PB_H_INCLUDED
#include <pb.h>
...
typedef struct _wippersnapper_uart_v1_UARTBusData {
    int32_t baudrate; /* * The baudrate to use for UART communication (may be a common baud rate such as: 1200bps, 2400bps, 4800bps, 19200bps, 38400bps, 57600bps, or 115200bps). */
...
typedef struct _wippersnapper_uart_v1_UARTDeviceAttachRequest {
    bool has_bus_info;
    wippersnapper_uart_v1_UARTBusData bus_info; /* * The UART bus configuration. */
    char device_id[15]; /* * The unique identifier of the device to attach to the UART bus, from Adafruit_WipperSnapper_Components. */
...
typedef struct _wippersnapper_uart_v1_UARTDeviceAttachResponse {
    char device_id[15]; /* * The unique identifier of the device to attach to the UART bus, from Adafruit_WipperSnapper_Components. */
    bool is_success; /* * True if the UARTInitRequest was successful, False otherwise. */
...
typedef struct _wippersnapper_uart_v1_UARTDeviceDetachRequest {
    char device_id[15]; /* * The unique identifier of the device to detach from the UART bus. */
...
#define WIPPERSNAPPER_UART_V1_UART_PB_H_MAX_SIZE wippersnapper_uart_v1_UARTDeviceEvent_size
