...
#define wippersnapper_signal_v1_I2CRequest_req_aht_init_tag 4
#define wippersnapper_signal_v1_I2CRequest_req_aht_deinit_tag 5
...
#define wippersnapper_signal_v1_I2CResponse_resp_aht_init_tag 3
...
X(a, STATIC,   ONEOF,    MSG_W_CB, (payload,req_aht_init,payload.req_aht_init),   4) \
X(a, STATIC,   ONEOF,    MSG_W_CB, (payload,req_aht_deinit,payload.req_aht_deinit),   5)
...
X(a, STATIC,   ONEOF,    MSG_W_CB, (payload,resp_aht_init,payload.resp_aht_init),   3)
...
union wippersnapper_signal_v1_I2CResponse_payload_size_union {char f3[(6 + wippersnapper_i2c_v1_AHTInitResponse_size)]; char f0[8];};
