...
#define wippersnapper_signal_v1_I2CResponse_resp_i2c_device_event_tag 5
...
X(a, STATIC,   ONEOF,    MSG_W_CB, (payload,resp_i2c_device_event,payload.resp_i2c_device_event),   5)
...
#if defined(wippersnapper_i2c_v1_I2CDeviceEvent_size)
union wippersnapper_signal_v1_I2CResponse_payload_size_union {char f5[(6 + wippersnapper_i2c_v1_I2CDeviceEvent_size)]; char f0[723];};
