...
typedef struct _wippersnapper_signal_v1_PWMRequest {
    ...
    pb_size_t which_payload;
    union {
        wippersnapper_pwm_v1_AttachRequest attach_request;
        wippersnapper_pwm_v1_DetachRequest detach_request;
        wippersnapper_pwm_v1_WriteDutyCycleRequest write_duty_request;
        wippersnapper_pwm_v1_WriteDutyCycleMultiRequest write_duty_multi_request;
        wippersnapper_pwm_v1_WriteFrequencyRequest write_freq_request;
    } payload;
...
typedef struct _wippersnapper_signal_v1_PWMResponse {
    ...
    pb_size_t which_payload;
    union {
        wippersnapper_pwm_v1_AttachResponse attach_response;
    } payload;
...
#define wippersnapper_signal_v1_PWMRequest_init_default {{{NULL}, NULL}, 0, {wippersnapper_pwm_v1_AttachRequest_init_default}}
#define wippersnapper_signal_v1_PWMResponse_init_default {{{NULL}, NULL}, 0, {wippersnapper_pwm_v1_AttachResponse_init_default}}
...
#define wippersnapper_signal_v1_PWMRequest_init_zero {{{NULL}, NULL}, 0, {wippersnapper_pwm_v1_AttachRequest_init_zero}}
#define wippersnapper_signal_v1_PWMResponse_init_zero {{{NULL}, NULL}, 0, {wippersnapper_pwm_v1_AttachResponse_init_zero}}
...
#define wippersnapper_signal_v1_PWMRequest_payload_attach_request_MSGTYPE wippersnapper_pwm_v1_AttachRequest
#define wippersnapper_signal_v1_PWMRequest_payload_detach_request_MSGTYPE wippersnapper_pwm_v1_DetachRequest
#define wippersnapper_signal_v1_PWMRequest_payload_write_duty_request_MSGTYPE wippersnapper_pwm_v1_WriteDutyCycleRequest
#define wippersnapper_signal_v1_PWMRequest_payload_write_duty_multi_request_MSGTYPE wippersnapper_pwm_v1_WriteDutyCycleMultiRequest
#define wippersnapper_signal_v1_PWMRequest_payload_write_freq_request_MSGTYPE wippersnapper_pwm_v1_WriteFrequencyRequest
...
#define wippersnapper_signal_v1_PWMResponse_payload_attach_response_MSGTYPE wippersnapper_pwm_v1_AttachResponse
