...
#if defined(wippersnapper_i2c_v1_I2CDeviceInitRequest_size) && defined(wippersnapper_i2c_v1_I2CDeviceUpdateRequest_size)
union wippersnapper_signal_v1_I2CRequest_payload_size_union {char f4[(6 + wippersnapper_i2c_v1_I2CDeviceInitRequest_size)]; char f6[(6 + wippersnapper_i2c_v1_I2CDeviceUpdateRequest_size)]; char f0[54];};
