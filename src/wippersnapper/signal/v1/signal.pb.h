...
typedef struct _wippersnapper_signal_v1_PixelRequest {
    pb_callback_t cb_payload;
    pb_size_t which_payload;
    union {
        wippersnapper_pixels_v1_PixelsCreate req_pixels_create;
        wippersnapper_pixels_v1_PixelsUpdate req_pixels_update;
        wippersnapper_pixels_v1_PixelsDelete req_pixels_delete;
        wippersnapper_pixels_v1_PixelsFillAll req_pixels_fill_all;
    } payload;
} wippersnapper_signal_v1_PixelRequest;
...
#define wippersnapper_signal_v1_PixelRequest_init_default {{{NULL}, NULL}, 0, {wippersnapper_pixels_v1_PixelsCreate_init_default}}
...
#define wippersnapper_signal_v1_PixelRequest_init_zero {{{NULL}, NULL}, 0, {wippersnapper_pixels_v1_PixelsCreate_init_zero}}
...
#define wippersnapper_signal_v1_PixelRequest_req_pixels_create_tag 1
#define wippersnapper_signal_v1_PixelRequest_req_pixels_update_tag 2
#define wippersnapper_signal_v1_PixelRequest_req_pixels_delete_tag 3
#define wippersnapper_signal_v1_PixelRequest_req_pixels_fill_all_tag 4
...
#define wippersnapper_signal_v1_PixelRequest_FIELDLIST(X, a) \
X(a, STATIC,   ONEOF,    MSG_W_CB, (payload,req_pixels_create,payload.req_pixels_create),   1) \
X(a, STATIC,   ONEOF,    MSG_W_CB, (payload,req_pixels_update,payload.req_pixels_update),   2) \
X(a, STATIC,   ONEOF,    MSG_W_CB, (payload,req_pixels_delete,payload.req_pixels_delete),   3) \
X(a, STATIC,   ONEOF,    MSG_W_CB, (payload,req_pixels_fill_all,payload.req_pixels_fill_all),   4)
#define wippersnapper_signal_v1_PixelRequest_CALLBACK NULL
#define wippersnapper_signal_v1_PixelRequest_DEFAULT NULL
#define wippersnapper_signal_v1_PixelRequest_payload_req_pixels_create_MSGTYPE wippersnapper_pixels_v1_PixelsCreate
#define wippersnapper_signal_v1_PixelRequest_payload_req_pixels_update_MSGTYPE wippersnapper_pixels_v1_PixelsUpdate
#define wippersnapper_signal_v1_PixelRequest_payload_req_pixels_delete_MSGTYPE wippersnapper_pixels_v1_PixelsDelete
#define wippersnapper_signal_v1_PixelRequest_payload_req_pixels_fill_all_MSGTYPE wippersnapper_pixels_v1_PixelsFillAll
...
extern const pb_msgdesc_t wippersnapper_signal_v1_PixelRequest_msg;
...
#define wippersnapper_signal_v1_PixelRequest_fields &wippersnapper_signal_v1_PixelRequest_msg
...
#define wippersnapper_signal_v1_PixelRequest_size 44
