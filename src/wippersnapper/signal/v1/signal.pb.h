...
/* Generated by nanopb-0.4.5-dev at Tue Jul 25 18:02:01 2023. */
...
typedef struct _wippersnapper_signal_v1_UARTRequest {
    pb_callback_t cb_payload;
    pb_size_t which_payload;
    union {
        wippersnapper_uart_v1_UARTInitRequest req_uart_init;
        wippersnapper_uart_v1_UARTDeviceAttachRequest req_uart_device_attach;
    } payload;
} wippersnapper_signal_v1_UARTRequest;

typedef struct _wippersnapper_signal_v1_UARTResponse {
    pb_callback_t cb_payload;
    pb_size_t which_payload;
    union {
        wippersnapper_uart_v1_UARTInitResponse resp_uart_init;
        wippersnapper_uart_v1_UARTDeviceAttachResponse resp_uart_device_attach;
    } payload;
...
#define wippersnapper_signal_v1_UARTRequest_init_default {{{NULL}, NULL}, 0, {wippersnapper_uart_v1_UARTInitRequest_init_default}}
#define wippersnapper_signal_v1_UARTResponse_init_default {{{NULL}, NULL}, 0, {wippersnapper_uart_v1_UARTInitResponse_init_default}}
...
#define wippersnapper_signal_v1_UARTRequest_init_zero {{{NULL}, NULL}, 0, {wippersnapper_uart_v1_UARTInitRequest_init_zero}}
#define wippersnapper_signal_v1_UARTResponse_init_zero {{{NULL}, NULL}, 0, {wippersnapper_uart_v1_UARTInitResponse_init_zero}}
...
#define wippersnapper_signal_v1_UARTRequest_req_uart_init_tag 1
#define wippersnapper_signal_v1_UARTRequest_req_uart_device_attach_tag 2
#define wippersnapper_signal_v1_UARTResponse_resp_uart_init_tag 1
#define wippersnapper_signal_v1_UARTResponse_resp_uart_device_attach_tag 2

/* Struct field encoding specification for nanopb */
#define wippersnapper_signal_v1_UARTRequest_FIELDLIST(X, a) \
X(a, STATIC,   ONEOF,    MSG_W_CB, (payload,req_uart_init,payload.req_uart_init),   1) \
X(a, STATIC,   ONEOF,    MSG_W_CB, (payload,req_uart_device_attach,payload.req_uart_device_attach),   2)
#define wippersnapper_signal_v1_UARTRequest_CALLBACK NULL
#define wippersnapper_signal_v1_UARTRequest_DEFAULT NULL
#define wippersnapper_signal_v1_UARTRequest_payload_req_uart_init_MSGTYPE wippersnapper_uart_v1_UARTInitRequest
#define wippersnapper_signal_v1_UARTRequest_payload_req_uart_device_attach_MSGTYPE wippersnapper_uart_v1_UARTDeviceAttachRequest

#define wippersnapper_signal_v1_UARTResponse_FIELDLIST(X, a) \
X(a, STATIC,   ONEOF,    MSG_W_CB, (payload,resp_uart_init,payload.resp_uart_init),   1) \
X(a, STATIC,   ONEOF,    MSG_W_CB, (payload,resp_uart_device_attach,payload.resp_uart_device_attach),   2)
#define wippersnapper_signal_v1_UARTResponse_CALLBACK NULL
#define wippersnapper_signal_v1_UARTResponse_DEFAULT NULL
#define wippersnapper_signal_v1_UARTResponse_payload_resp_uart_init_MSGTYPE wippersnapper_uart_v1_UARTInitResponse
#define wippersnapper_signal_v1_UARTResponse_payload_resp_uart_device_attach_MSGTYPE wippersnapper_uart_v1_UARTDeviceAttachResponse
...
#define wippersnapper_signal_v1_UARTResponse_fields &wippersnapper_signal_v1_UARTResponse_msg
...
#if defined(wippersnapper_uart_v1_UARTInitRequest_size) && defined(wippersnapper_uart_v1_UARTDeviceAttachRequest_size)
union wippersnapper_signal_v1_UARTRequest_payload_size_union {char f1[(6 + wippersnapper_uart_v1_UARTInitRequest_size)]; char f2[(6 + wippersnapper_uart_v1_UARTDeviceAttachRequest_size)];};
#define wippersnapper_signal_v1_UARTRequest_size (0 + sizeof(union wippersnapper_signal_v1_UARTRequest_payload_size_union))
#endif
#if defined(wippersnapper_uart_v1_UARTDeviceAttachResponse_size)
union wippersnapper_signal_v1_UARTResponse_payload_size_union {char f2[(6 + wippersnapper_uart_v1_UARTDeviceAttachResponse_size)]; char f0[4];};
#define wippersnapper_signal_v1_UARTResponse_size (0 + sizeof(union wippersnapper_signal_v1_UARTResponse_payload_size_union))
#endif
