...
typedef struct _wippersnapper_signal_v1_Ds18x20Response {
    ...
    union {
        ...
        wippersnapper_ds18x20_v1_Ds18x20DeInitResponse resp_ds18x20_deinit;
...
X(a, STATIC,   ONEOF,    MSG_W_CB, (payload,resp_ds18x20_deinit,payload.resp_ds18x20_deinit),   2) \
X(a, STATIC,   ONEOF,    MSG_W_CB, (payload,resp_ds18x20_event,payload.resp_ds18x20_event),   3)
