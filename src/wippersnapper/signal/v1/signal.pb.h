...
union wippersnapper_signal_v1_I2CRequest_payload_size_union {char f2[(6 + wippersnapper_i2c_v1_I2CScanRequest_size)]; char f0[41];};
...
union wippersnapper_signal_v1_I2CResponse_payload_size_union {char f3[(6 + wippersnapper_i2c_v1_AHTInitResponse_size)]; char f0[4];};
