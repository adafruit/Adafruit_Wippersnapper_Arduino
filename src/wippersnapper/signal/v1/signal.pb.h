...
#if defined(wippersnapper_uart_v1_UARTDeviceAttachRequest_size)
#define wippersnapper_signal_v1_UARTRequest_size (6 + wippersnapper_uart_v1_UARTDeviceAttachRequest_size)
#endif
#if defined(wippersnapper_uart_v1_UARTDeviceAttachResponse_size)
#define wippersnapper_signal_v1_UARTResponse_size (6 + wippersnapper_uart_v1_UARTDeviceAttachResponse_size)
#endif
