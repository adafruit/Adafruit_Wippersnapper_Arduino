...
typedef struct _wippersnapper_description_v1_CreateDescriptionResponse { 
    wippersnapper_description_v1_CreateDescriptionResponse_Response response; /* * True if device successfully configured its components, False otherwise. */
...
typedef struct _wippersnapper_description_v1_RegistrationComplete { 
    bool is_complete; /* Request may be any UTF-8 string value */
