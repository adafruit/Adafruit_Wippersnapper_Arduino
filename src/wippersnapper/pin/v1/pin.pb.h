...
#ifndef PB_WIPPERSNAPPER_PIN_V1_PIN_PB_H_INCLUDED
#define PB_WIPPERSNAPPER_PIN_V1_PIN_PB_H_INCLUDED
#include <pb.h>
...
typedef enum _wippersnapper_pin_v1_Mode {
    wippersnapper_pin_v1_Mode_MODE_UNSPECIFIED = 0, /* * Invalid Mode from Broker. */
    wippersnapper_pin_v1_Mode_MODE_ANALOG = 1, /* * Set up an analog pin. */
    wippersnapper_pin_v1_Mode_MODE_DIGITAL = 2 /* * Set up a digital pin. */
...
typedef enum _wippersnapper_pin_v1_ConfigurePinRequest_Direction {
    wippersnapper_pin_v1_ConfigurePinRequest_Direction_DIRECTION_UNSPECIFIED = 0, /* * Invalid Direction from Broker. */
    wippersnapper_pin_v1_ConfigurePinRequest_Direction_DIRECTION_INPUT = 1, /* * Set the pin to behave as an input. */
    wippersnapper_pin_v1_ConfigurePinRequest_Direction_DIRECTION_OUTPUT = 2 /* * Set the pin to behave as an output. */
...
typedef enum _wippersnapper_pin_v1_ConfigurePinRequest_Pull {
    wippersnapper_pin_v1_ConfigurePinRequest_Pull_PULL_UNSPECIFIED = 0, /* * Invalid Direction from Broker. */
    wippersnapper_pin_v1_ConfigurePinRequest_Pull_PULL_UP = 1, /* * Set the pin to pull high. */
    wippersnapper_pin_v1_ConfigurePinRequest_Pull_PULL_DOWN = 2 /* * Set the pin to pull low. */
...
typedef enum _wippersnapper_pin_v1_ConfigurePinRequest_RequestType {
    wippersnapper_pin_v1_ConfigurePinRequest_RequestType_REQUEST_TYPE_UNSPECIFIED = 0, /* * Invalid request from Broker. */
    wippersnapper_pin_v1_ConfigurePinRequest_RequestType_REQUEST_TYPE_CREATE = 1, /* * The request creates a pin. */
    wippersnapper_pin_v1_ConfigurePinRequest_RequestType_REQUEST_TYPE_UPDATE = 2, /* * The request updates a previously created pin. */
    wippersnapper_pin_v1_ConfigurePinRequest_RequestType_REQUEST_TYPE_DELETE = 3 /* * The request deletes a previously created pin. */
...
typedef struct _wippersnapper_pin_v1_ConfigurePinRequest {
    char pin_name[5]; /* * The name of pin we are accessing. */
    wippersnapper_pin_v1_Mode mode; /* * Specifies the pin's type, analog or input. */
    wippersnapper_pin_v1_ConfigurePinRequest_Direction direction; /* * Specifies the pin's behavior. */
    wippersnapper_pin_v1_ConfigurePinRequest_Pull pull; /* * Specifies an optional pullup resistor value. */
    float period; /* * Specifies the time between measurements, in seconds. */
    wippersnapper_pin_v1_ConfigurePinRequest_RequestType request_type; /* * Specifies the type of ConfigurePinRequest. */
    float aref; /* * deprecated: Specifies the reference voltage used for analog input, defaults to 3.3v. */
    wippersnapper_pin_v1_ConfigurePinRequest_AnalogReadMode analog_read_mode; /* * ANALOG-ONLY: Specifies the read mode for an analog pin. */
} wippersnapper_pin_v1_ConfigurePinRequest;

/* *
 Pin Event. Describes a pin's value. */
typedef struct _wippersnapper_pin_v1_PinEvent {
    char pin_name[5]; /* * Specifies the pin's name. */
    char pin_value[12]; /* * Specifies the pin's value. */
...
typedef struct _wippersnapper_pin_v1_ConfigureReferenceVoltage {
    float reference_voltage; /* * Specifies an ADC reference voltage. */
...
#define wippersnapper_pin_v1_ConfigurePinRequest_mode_ENUMTYPE wippersnapper_pin_v1_Mode
#define wippersnapper_pin_v1_ConfigurePinRequest_direction_ENUMTYPE wippersnapper_pin_v1_ConfigurePinRequest_Direction
#define wippersnapper_pin_v1_ConfigurePinRequest_pull_ENUMTYPE wippersnapper_pin_v1_ConfigurePinRequest_Pull
#define wippersnapper_pin_v1_ConfigurePinRequest_request_type_ENUMTYPE wippersnapper_pin_v1_ConfigurePinRequest_RequestType
#define wippersnapper_pin_v1_ConfigurePinRequest_analog_read_mode_ENUMTYPE wippersnapper_pin_v1_ConfigurePinRequest_AnalogReadMode
...
#define WIPPERSNAPPER_PIN_V1_PIN_PB_H_MAX_SIZE   wippersnapper_pin_v1_ConfigurePinRequest_size
