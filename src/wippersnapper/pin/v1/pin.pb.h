...
typedef enum _wippersnapper_pin_v1_ConfigurePinRequest_Direction { 
    wippersnapper_pin_v1_ConfigurePinRequest_Direction_DIRECTION_UNSPECIFIED = 0, /* * Invalid Mode from Broker. */
    wippersnapper_pin_v1_ConfigurePinRequest_Direction_DIRECTION_INPUT = 1, /* * Set up an analog pin. */
    wippersnapper_pin_v1_ConfigurePinRequest_Direction_DIRECTION_OUTPUT = 2 /* * Set up a digital pin. */
