...
typedef struct _wippersnapper_i2c_v1_I2CBusInitResponse {
    wippersnapper_i2c_v1_BusResponse response;
...
#define _wippersnapper_i2c_v1_BusResponse_MAX wippersnapper_i2c_v1_BusResponse_BUS_RESPONSE_ERROR_PULLUPS
#define _wippersnapper_i2c_v1_BusResponse_ARRAYSIZE ((wippersnapper_i2c_v1_BusResponse)(wippersnapper_i2c_v1_BusResponse_BUS_RESPONSE_ERROR_PULLUPS+1))
...
#define wippersnapper_i2c_v1_I2CBusInitResponse_response_tag 2
