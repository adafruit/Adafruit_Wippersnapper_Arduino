...
#define wippersnapper_i2c_v1_I2CScanRequest_init_default {{{NULL}, NULL}, 0, 0, 0, 0}
...
#define wippersnapper_i2c_v1_I2CScanRequest_init_zero {{{NULL}, NULL}, 0, 0, 0, 0}
...
#define wippersnapper_i2c_v1_I2CScanRequest_frequency_tag 2
#define wippersnapper_i2c_v1_I2CScanRequest_pin_scl_tag 3
#define wippersnapper_i2c_v1_I2CScanRequest_pin_sda_tag 4
#define wippersnapper_i2c_v1_I2CScanRequest_bus_id_tag 5
#define wippersnapper_i2c_v1_I2CScanResponse_is_address_found_tag 1
...
X(a, CALLBACK, REPEATED, UINT32,   address,           1) \
X(a, STATIC,   SINGULAR, UINT32,   frequency,         2) \
X(a, STATIC,   SINGULAR, INT32,    pin_scl,           3) \
X(a, STATIC,   SINGULAR, INT32,    pin_sda,           4) \
X(a, STATIC,   SINGULAR, INT32,    bus_id,            5)
#define wippersnapper_i2c_v1_I2CScanRequest_CALLBACK pb_default_field_callback
...
X(a, STATIC,   SINGULAR, BOOL,     is_address_found,   1)
...
/* wippersnapper_i2c_v1_I2CScanRequest_size depends on runtime parameters */
#define wippersnapper_i2c_v1_I2CSetFrequency_size 17
#define wippersnapper_i2c_v1_I2CScanResponse_size 2
