...
#define wippersnapper_i2c_v1_SensorEvent_raw_captouch_tag 12
...
X(a, STATIC,   ONEOF,    UINT32,   (event_data,raw_captouch,event_data.raw_captouch),  12)
