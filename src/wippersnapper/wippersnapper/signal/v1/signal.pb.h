...
#define wippersnapper_signal_v1_CreateSignalRequest_init_default {0, {wippersnapper_pin_v1_ConfigurePinRequests_init_default}}
#define wippersnapper_signal_v1_CreateSignalResponse_init_default {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}}
#define wippersnapper_signal_v1_CreateSignalRequest_init_zero {0, {wippersnapper_pin_v1_ConfigurePinRequests_init_zero}}
...
X(a, STATIC,   ONEOF,    MESSAGE,  (payload,pin_configs,payload.pin_configs),   6) \
X(a, STATIC,   ONEOF,    MESSAGE,  (payload,pin_events,payload.pin_events),   7) \
X(a, STATIC,   ONEOF,    MESSAGE,  (payload,sensor_configs,payload.sensor_configs),   8) \
X(a, STATIC,   ONEOF,    MESSAGE,  (payload,sensor_events,payload.sensor_events),   9) \
X(a, STATIC,   ONEOF,    MESSAGE,  (payload,pwm_pin_config,payload.pwm_pin_config),  10) \
X(a, STATIC,   ONEOF,    MESSAGE,  (payload,pwm_pin_event,payload.pwm_pin_event),  12) \
X(a, STATIC,   ONEOF,    MESSAGE,  (payload,pixel_config,payload.pixel_config),  13) \
X(a, STATIC,   ONEOF,    MESSAGE,  (payload,pixel_event,payload.pixel_event),  14)
