/*!
 * @file src/components/display/drivers/dispDrvThinkInkMonoM06.h
 *
 * Driver for ThinkInk 2.9" Monochrome M06 display (UC8151D) (296x128)
 *
 ...
 *
 */
#ifndef WS_DRV_THINKINK_MONO_M06_H
#define WS_DRV_THINKINK_MONO_M06_H

#include "dispDrvBase.h"

/*!
    @brief  Driver for a ThinkInk 2.9" Monochrome M06 display (UC8151D).
*/
class dispDrvThinkInkMonoM06 : public dispDrvBase {
public:
  /*!
      @brief  Constructor for the ThinkInk 2.9" Monochrome M06 driver.
  ...
  */
  bool begin(thinkinkmode_t mode, bool reset = true) override {
    (void)reset;
    _display = new ThinkInk_290_Mono_M06(_pin_dc, _pin_rst, _pin_cs,
...
#endif // WS_DRV_THINKINK_MONO_M06_H
