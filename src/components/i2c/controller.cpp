...
bool I2cController::Handle_Add(
  ...
  if (drv == nullptr) {
    ...
    publishDeviceAddedOrReplaced(device_descriptor, hw_bus, ws_i2c_Status_S_FAIL_INIT);
    return false;
  }
  ...
  publishDeviceAddedOrReplaced(device_descriptor, hw_bus, ws_i2c_Status_S_SUCCESS);
  WS_DEBUG_PRINTLN("OK!");
