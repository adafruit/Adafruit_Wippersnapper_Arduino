...
public:
  ...
  */
  ...
  bool begin() override {
    ...
    //  - Gain (setGain): 1x..2048x, trades sensitivity for saturation range.
    //  - Integration time (setIntegrationTime): 1ms..16384ms.
    //  - Measurement mode (setMeasurementMode): continuous / command / sync.
    //  - Clock frequency and break time tuning.
