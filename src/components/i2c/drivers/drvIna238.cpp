...
*/
/*******************************************************************************/
bool drvIna238::configureDefaults() {
  _ina238->setShunt(_shuntResistance, _maxCurrent);
...
*/
/*******************************************************************************/
bool drvIna238::setShuntResistance(const ws_config_Value &shunt_resistance) {
...
*/
/*******************************************************************************/
bool drvIna238::setMaxCurrent(const ws_config_Value &max_current) {
  float v = _maxCurrent;
...
*/
/*******************************************************************************/
bool drvIna238::setAdcRange(const ws_config_Value &adc_range) {
  ...
  _ina238->setADCRange((uint8_t)val);
  return true;
}
...
*/
/*******************************************************************************/
bool drvIna238::setAveragedSamples(const ws_config_Value &averaged_samples) {
  ...
  _ina238->setAveragingCount(count);
  return true;
}
...
*/
/*******************************************************************************/
bool drvIna238::setVoltageConversionTime(
  ...
  _ina238->setVoltageConversionTime(time);
  return true;
}
...
*/
/*******************************************************************************/
bool drvIna238::setCurrentConversionTime(
  ...
  _ina238->setCurrentConversionTime(time);
  return true;
}
...
bool drvIna238::getEventCurrent(sensors_event_t *currentEvent) {
  ...
  if (_ina238->alertFunctionFlags() & (1u << 9))
    return false;
...
/*!
    @brief    Checks the INA238's conversion-ready flag (DIAG_ALRT CNVRF),
...
*/
bool drvIna238::IsSensorReady() { return _ina238->conversionReady(); }
