...
public:
  ...
  */
  ...
  bool begin() override {
    ...
    return _tmp119->begin((uint8_t)_address, _i2c);
  }

  /*******************************************************************************/
  /*!
      @brief    Configures the TMP119 sensor with default settings. Explicit
                defaults are applied so a future library change cannot silently
  ...
  */
  ...
  bool setAveragedSamples(const ws_config_Value &averaged_samples) override {
    ...
    return _tmp119->setAveragedSampleCount(count);
  }
  ...
  */
  ...
  bool setReadDelay(const ws_config_Value &read_delay) override {
    ...
    return _tmp119->setReadDelay(delay);
  }
