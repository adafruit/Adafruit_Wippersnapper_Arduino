...
class Adafruit_INA228; ///< Forward declaration (lib header included in .cpp)
...
/*!
    ...
    The INA228 (20-bit) also exposes power, energy and charge accumulators that
    could be surfaced as additional metrics in future.
*/
/**************************************************************************/
