...
public:
  ...
  // AnalogInEvent
  bool EncodeAnalogInEvent(uint8_t pin, float pin_value,
                           ws_sensor_Type read_type);
  bool EncodeAnalogInEventVoltage(uint8_t pin, float pin_value);
  bool EncodeAnalogInEventRaw(uint8_t pin, float pin_value);
