...
## ESP32-S2 ##
esp32s2: esp32s2-funhouse esp32s2-metro
clean-esp32s2: clean-esp32s2-funhouse clean-esp32s2-metro
...
esp32s2-metro:
			...
			python3 $(UF2CONV) examples/Wippersnapper_demo/build/esp32.esp32.adafruit_metro_esp32s2/Wippersnapper_demo.ino.bin -f $(UF2_FAMILY_ESP32S2) -b $(UF2_BASE_ESP32S2) -o build/esp32s2-funhouse/$(PROJECT_NAME)-$(BOARD_METRO_S2)-$(PROJECT_VER_MAJOR)-$(PROJECT_VER_MINOR)-$(PROJECT_VER_PATCH)-$(PROJECT_VER_BUILD)-$(PROJECT_VER_BUILD_NUM).uf2
